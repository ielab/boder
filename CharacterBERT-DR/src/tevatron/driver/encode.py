...
from tevatron.modeling import DenseOutput, DenseModelForInference, SimLMForInference
...
def main():
    ...
    if 'intfloat' in model_args.model_name_or_path:
        model = SimLMForInference.build(
    ...
    if not os.path.exists(data_args.encoded_save_path):
        os.makedirs(data_args.encoded_save_path)

    with open(data_args.encoded_save_path+f'/split{data_args.encode_shard_index}.pkl', 'wb') as f:
