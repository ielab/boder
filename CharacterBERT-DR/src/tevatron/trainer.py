...
class SelfTeachingDenseTrainerKD(SelfTeachingDenseTrainer):
    def compute_loss(self, model, inputs):
        query, typo_query, passage, ce_batch = inputs
        return model(query=query, typo_query=typo_query, passage=passage, ce_batch=ce_batch).loss
